...
const Register = () => {
  ...
  return (
    ...
    <div className='flex overflow-hidden'>
      <div className='w-1/2'>
          <img src={register} style={{height: '96.5%' }}></img>
      </div>
      <div className='w-1/3'>
          <p className='text-[#FF9B3F] text-lg text-center my-[35px] font-semibold'>Career is a journey not a destination ... 
            <br />Let's find the way together...</p>
          <h1 className='text-5xl text-center mt-[25px] font-bold'>
              Register
          </h1>
